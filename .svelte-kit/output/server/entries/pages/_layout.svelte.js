...
function Header($$renderer, $$props) {
  ...
  $$renderer.push(`<header${attr_class(`site-header ${transparent ? "is-transparent" : ""}`, "svelte-1elxaub")}><div class="container header-inner svelte-1elxaub"><a class="logo svelte-1elxaub" href="/"><img src="/images/logo.png" alt="Fartech Logo" class="svelte-1elxaub"/></a> <nav class="svelte-1elxaub"><!--[-->`);
